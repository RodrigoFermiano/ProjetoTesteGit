...
{
    /// <summary>
    /// Informação do valor de receita com redução (faixa A).
    /// Nível hierárquico – 5
    /// Ocorrência – 0:N
    /// 
    /// </summary>
    /// 
    public class REG_03112_VALOR_RECEITA_ATIVIDADE_PERCENTUAL_FAIXA_A
    {
        ...
        /// <summary>
        /// Percentual de redução aplicado ao ICMS/ISS para o valor de receita informado em 02
        /// </summary>
